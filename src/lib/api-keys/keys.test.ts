...
describe('hashApiKey', () => {
  it('is deterministic', () => {
    expect(hashApiKey('melissacrm_live_abc')).toBe(hashApiKey('melissacrm_live_abc'));
  });

  it('differs for different inputs', () => {
    expect(hashApiKey('melissacrm_live_abc')).not.toBe(hashApiKey('melissacrm_live_abd'));
  });
});
...
describe('timingSafeHexEqual', () => {
  it('is true for identical digests', () => {
    const h = hashApiKey('melissacrm_live_xyz');

...
//
// Why the `melissacrm_live_` prefix
//   - Self-identifying: a leaked string is instantly recognisable as
//     a Clube Melissa CRM key (handy for secret-scanners like GitGuardian).
//   - Forward-compatible: leaves room for a `melissacrm_test_` variant if
...
export const API_KEY_PREFIX = 'melissacrm_live_';

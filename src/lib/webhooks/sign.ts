...
//
// Every delivery carries an `X-MelissaCRM-Signature` header so receivers
// can verify the request really came from Clube Melissa CRM and wasn't
// tampered with or replayed. The scheme is Stripe-style:
//
//   X-MelissaCRM-Signature: t=<unix_seconds>,v1=<hex HMAC-SHA256>
//
...
/**
 * Build the `X-MelissaCRM-Signature` header value for `rawBody`, signed
 ...
 * instances of Clube Melissa CRM (or a test) can validate deliveries;
 * receivers in other stacks

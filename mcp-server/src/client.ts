// ============================================================
// Clube Melissa CRM public API client.
//
...
/** A structured error from the Clube Melissa CRM API envelope (`{ error: { code, message } }`). */
  ...
  private async request<T>(
    ...
    try {
      ...
      throw new WacrmApiError(
        0,
        'network_error',
        `Could not reach Clube Melissa CRM at ${this.baseUrl}: ${(err as Error).message}`,
      );
    }
